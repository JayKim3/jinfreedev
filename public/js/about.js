...
$(document).ready(function() {
  ...
  $(".about-page")
    .delay(500)
    .removeClass("black", 1000);
  $(".canvas-character ").removeClass("hide", 500);
  characterDraw();
  $(".Iam-names")
    .delay(200)
    .removeClass("hide", 1500);
  $(".about-navigation")
    .delay(1800)
...
$(window).scroll(function() {
  ...
  $(".about-page").each(function(pageIndex) {
    ...
    if (nowScroll > start && nowScroll < end) {
      ...
      if (pageIndex == 2) {
        if (nowScroll > start + 600) {
          $(".timeline").removeClass("darkbg", 500);
        } else {
          $(".timeline").addClass("darkbg", 500);
        }
      }
    }
  });
...
$(".about-navigation-btn").click(function() {
  ...
  $("html")
    .stop()
    .animate({ scrollTop: positionTop }, 900, function() {
      canClick = true;
    });
});
